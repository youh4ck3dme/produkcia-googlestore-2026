...
echo ""
echo "Natívny macOS build (vyžaduje Xcode z App Store):"
echo "  for f in integration_test/*_test.dart; do"
echo "    flutter test \"\$f\" -d macos --dart-define=PLAY_MVP=true --dart-define=CI=true"
echo "  done"
